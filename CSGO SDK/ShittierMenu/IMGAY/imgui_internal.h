...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginGroupBoxEx(const char* name, ImGuiID id, ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          TabEx(const char* icon, const char* label, const ImVec2& size_arg = ImVec2(0, 0), bool selected = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          SubTabEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), bool selected = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          DisabledTabEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), bool selected = false, ImGuiButtonFlags flags = 0);
