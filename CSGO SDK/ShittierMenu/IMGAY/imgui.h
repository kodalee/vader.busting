...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginComboWindow(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0);
    IMGUI_API void          End();

    IMGUI_API bool          BeginGroupBox(const char* str_id, ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          BeginGroupBox(ImGuiID id, ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          Tab(const char* icon, const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false);
    IMGUI_API bool          SubTab(const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false);
    IMGUI_API bool          DisabledTab(const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false);
    ...
    IMGUI_API bool          Keybind(const char* id, int* currentKey, int* keyType = NULL);
    ...
    IMGUI_API bool          ColorButton(const char* desc_id, ImVec4& col, ImGuiColorEditFlags flags = 0, ImVec2 size = ImVec2(0, 0)); // display a color square/button, hover for details, return true when pressed.
...
{
    ImGuiCol_Accent,
    ImGuiCol_AccentDarker,
    ImGuiCol_AccentLight,
    ImGuiCol_AccentNoAlpha,
    ImGuiCol_Text,
