...
bool c_lua::initialize() {
	...
	this->lua.open_libraries(sol::lib::base, sol::lib::string, sol::lib::math, sol::lib::table, sol::lib::debug, sol::lib::package, sol::lib::coroutine, sol::lib::io, sol::lib::bit32, sol::lib::ffi, sol::lib::jit);
