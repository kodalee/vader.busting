...
namespace Engine
{
	...
	void Create( ) {
		...
		Displacement.DT_BaseViewModel.m_flCycle = pPropManager->GetOffset( XorStr( "DT_BaseViewModel" ), XorStr( "m_flCycle" ) );
		...
		Displacement.Data.m_uListLeavesInBoxReturn = Memory::Scan( image_client, XorStr( "56 57 FF 52 ? 8B 7D" ) ) + 0x5;
