...
#pragma region Skin Changer
	...
	config_option(int, knife, 0);
	config_option(bool, enable, false);

	config_option(int, id_deagle, 0);
	config_option(int, stattrak_deagle, 0);
	config_option(int, seed_deagle, 0);
	config_option(int, quality_deagle, 0);
	config_option(int, id_elite, 0);
	config_option(int, stattrak_elite, 0);
	config_option(int, seed_elite, 0);
	config_option(int, quality_elite, 0);
	config_option(int, id_fiveseven, 0);
	config_option(int, stattrak_fiveseven, 0);
	config_option(int, seed_fiveseven, 0);
	config_option(int, quality_fiveseven, 0);
	config_option(int, id_glock, 0);
	config_option(int, stattrak_glock, 0);
	config_option(int, seed_glock, 0);
	config_option(int, quality_glock, 0);
	config_option(int, id_ak47, 0);
	config_option(int, stattrak_ak47, 0);
	config_option(int, seed_ak47, 0);
	config_option(int, quality_ak47, 0);
	config_option(int, id_aug, 0);
	config_option(int, stattrak_aug, 0);
	config_option(int, seed_aug, 0);
	config_option(int, quality_aug, 0);
	config_option(int, id_awp, 0);
	config_option(int, stattrak_awp, 0);
	config_option(int, seed_awp, 0);
	config_option(int, quality_awp, 0);
	config_option(int, id_famas, 0);
	config_option(int, stattrak_famas, 0);
	config_option(int, seed_famas, 0);
	config_option(int, quality_famas, 0);
	config_option(int, id_g3sg1, 0);
	config_option(int, stattrak_g3sg1, 0);
	config_option(int, seed_g3sg1, 0);
	config_option(int, quality_g3sg1, 0);
	config_option(int, id_galil, 0);
	config_option(int, stattrak_galil, 0);
	config_option(int, seed_galil, 0);
	config_option(int, quality_galil, 0);
	config_option(int, id_m249, 0);
	config_option(int, stattrak_m249, 0);
	config_option(int, seed_m249, 0);
	config_option(int, quality_m249, 0);
	config_option(int, id_m4a4, 0);
	config_option(int, stattrak_m4a4, 0);
	config_option(int, seed_m4a4, 0);
	config_option(int, quality_m4a4, 0);
	config_option(int, id_mac10, 0);
	config_option(int, stattrak_mac10, 0);
	config_option(int, seed_mac10, 0);
	config_option(int, quality_mac10, 0);
	config_option(int, id_p90, 0);
	config_option(int, stattrak_p90, 0);
	config_option(int, seed_p90, 0);
	config_option(int, quality_p90, 0);
	config_option(int, id_ump45, 0);
	config_option(int, stattrak_ump45, 0);
	config_option(int, seed_ump45, 0);
	config_option(int, quality_ump45, 0);
	config_option(int, id_xm1014, 0);
	config_option(int, stattrak_xm1014, 0);
	config_option(int, seed_xm1014, 0);
	config_option(int, quality_xm1014, 0);
	config_option(int, id_bizon, 0);
	config_option(int, stattrak_bizon, 0);
	config_option(int, seed_bizon, 0);
	config_option(int, quality_bizon, 0);
	config_option(int, id_mag7, 0);
	config_option(int, stattrak_mag7, 0);
	config_option(int, seed_mag7, 0);
	config_option(int, quality_mag7, 0);
	config_option(int, id_negev, 0);
	config_option(int, stattrak_negev, 0);
	config_option(int, seed_negev, 0);
	config_option(int, quality_negev, 0);
	config_option(int, id_sawedoff, 0);
	config_option(int, stattrak_sawedoff, 0);
	config_option(int, seed_sawedoff, 0);
	config_option(int, quality_sawedoff, 0);
	config_option(int, id_tec9, 0);
	config_option(int, stattrak_tec9, 0);
	config_option(int, seed_tec9, 0);
	config_option(int, quality_tec9, 0);
	config_option(int, id_p2000, 0);
	config_option(int, stattrak_p2000, 0);
	config_option(int, seed_p2000, 0);
	config_option(int, quality_p2000, 0);
	config_option(int, id_mp7, 0);
	config_option(int, stattrak_mp7, 0);
	config_option(int, seed_mp7, 0);
	config_option(int, quality_mp7, 0);
	config_option(int, id_mp9, 0);
	config_option(int, stattrak_mp9, 0);
	config_option(int, seed_mp9, 0);
	config_option(int, quality_mp9, 0);
	config_option(int, id_nova, 0);
	config_option(int, stattrak_nova, 0);
	config_option(int, seed_nova, 0);
	config_option(int, quality_nova, 0);
	config_option(int, id_p250, 0);
	config_option(int, stattrak_p250, 0);
	config_option(int, seed_p250, 0);
	config_option(int, quality_p250, 0);
	config_option(int, id_scar20, 0);
	config_option(int, stattrak_scar20, 0);
	config_option(int, seed_scar20, 0);
	config_option(int, quality_scar20, 0);
	config_option(int, id_sg553, 0);
	config_option(int, stattrak_sg553, 0);
	config_option(int, seed_sg553, 0);
	config_option(int, quality_sg553, 0);
	config_option(int, id_ssg08, 0);
	config_option(int, stattrak_ssg08, 0);
	config_option(int, seed_ssg08, 0);
	config_option(int, quality_ssg08, 0);
	config_option(int, id_m4a1s, 0);
	config_option(int, stattrak_m4a1s, 0);
	config_option(int, seed_m4a1s, 0);
	config_option(int, quality_m4a1s, 0);
	config_option(int, id_usps, 0);
	config_option(int, stattrak_usps, 0);
	config_option(int, seed_usps, 0);
	config_option(int, quality_usps, 0);
	config_option(int, id_cz75a, 0);
	config_option(int, stattrak_cz75a, 0);
	config_option(int, seed_cz75a, 0);
	config_option(int, quality_cz75a, 0);
	config_option(int, id_revolver, 0);
	config_option(int, stattrak_revolver, 0);
	config_option(int, seed_revolver, 0);
	config_option(int, quality_revolver, 0);
	config_option(int, id_bayonet, 0);
	config_option(int, stattrak_bayonet, 0);
	config_option(int, seed_bayonet, 0);
	config_option(int, quality_bayonet, 0);
	config_option(int, id_flip, 0);
	config_option(int, stattrak_flip, 0);
	config_option(int, seed_flip, 0);
	config_option(int, quality_flip, 0);
	config_option(int, id_gut, 0);
	config_option(int, stattrak_gut, 0);
	config_option(int, seed_gut, 0);
	config_option(int, quality_gut, 0);
	config_option(int, id_karambit, 0);
	config_option(int, stattrak_karambit, 0);
	config_option(int, seed_karambit, 0);
	config_option(int, quality_karambit, 0);
	config_option(int, id_m9, 0);
	config_option(int, stattrak_m9, 0);
	config_option(int, seed_m9, 0);
	config_option(int, quality_m9, 0);
	config_option(int, id_huntsman, 0);
	config_option(int, stattrak_huntsman, 0);
	config_option(int, seed_huntsman, 0);
	config_option(int, quality_huntsman, 0);
	config_option(int, id_falchion, 0);
	config_option(int, stattrak_falchion, 0);
	config_option(int, seed_falchion, 0);
	config_option(int, quality_falchion, 0);
	config_option(int, id_bowie, 0);
	config_option(int, stattrak_bowie, 0);
	config_option(int, seed_bowie, 0);
	config_option(int, quality_bowie, 0);
	config_option(int, id_butterfly, 0);
	config_option(int, stattrak_butterfly, 0);
	config_option(int, seed_butterfly, 0);
	config_option(int, quality_butterfly, 0);
	config_option(int, id_daggers, 0);
	config_option(int, stattrak_daggers, 0);
	config_option(int, seed_daggers, 0);
	config_option(int, quality_daggers, 0);
