...
#pragma region Rage general group
	...
	config_option(bool, exploit_standbychoke, false)
...
//	config_option( int, search_max_ping, 100 );
	...
	config_option( bool, watermarkadditives_WATERMARK_TIME, false );
	config_option( bool, watermarkadditives_WATERMARK_FPS, false );
	...
	config_option(int, p250_skin, 1);
	config_option(int, fiveseven_skin, 1);
	config_option(int, tec9_skin, 1);
	config_option(int, cz75a_skin, 1);
	config_option(int, elite_skin, 1);
	config_option(int, deagle_skin, 1);
	config_option(int, revolver_skin, 1);
	config_option(int, famas_skin, 1);
	config_option(int, galilar_skin, 1);
	config_option(int, m4a1_skin, 1);
	config_option(int, m4a1s_skin, 1);
	config_option(int, ak47_skin, 1);
	config_option(int, sg556_skin, 1);
	config_option(int, aug_skin, 1);
	config_option(int, ssg08_skin, 1);
	config_option(int, awp_skin, 1);
	config_option(int, scar20_skin, 1);
	config_option(int, g3sg1_skin, 1);
	config_option(int, sawedoff_skin, 1);
	config_option(int, m249_skin, 1);
	config_option(int, negev_skin, 1);
	config_option(int, mag7_skin, 1);
	config_option(int, xm1014_skin, 1);
	config_option(int, nova_skin, 1);
	config_option(int, bizon_skin, 1);
	config_option(int, mp7_skin, 1);
	config_option(int, mp9_skin, 1);
	config_option(int, mac10_skin, 1);
	config_option(int, p90_skin, 1);
	config_option(int, ump45_skin, 1);
